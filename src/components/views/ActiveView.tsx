...
export default function ActiveView() {
    ...
    return (
        <>
            ...
            {/* Chat Workspace */}
            <section className="flex-1 overflow-y-auto px-6 pb-32 custom-scrollbar">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-background-light dark:from-background-dark via-background-light dark:via-background-dark to-transparent">
                <div className="max-w-4xl mx-auto flex items-end gap-4">
                    <div className="flex-1 relative group">
                        ...
                        />
                        <button className="absolute left-4 bottom-4 text-slate-400 hover:text-primary transition">
                            <span className="material-icons">mic</span>
                        </button>
                        <button
                            onClick={handleSend}
                            className="absolute right-4 bottom-3.5 w-8 h-8 bg-primary rounded-lg flex items-center justify-center text-white shadow-lg shadow-primary/20 hover:scale-105 active:scale-95 transition"
                        >
                    ...
                    <button
                        ...
                        className="bg-red-500/10 hover:bg-red-500/20 text-red-500 border border-red-500/30 px-6 py-4 rounded-xl text-xs font-bold uppercase tracking-widest transition flex-shrink-0"
                    >
                        Finish Interview
                    </button>
                </div>
